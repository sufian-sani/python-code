...
class InstallCommand(RequirementCommand):
    ...
    def add_options(self):
        ...
        self.cmd_opts.add_option(
            ...
            dest='use_user_site',
            action='store_true',
            help="Install to the Python Learn user install directory for your "
                 "platform. Typically ~/.local/, or %APPDATA%\\Python Learn on "
                 "Windows. (See the Python Learn documentation for site.USER_BASE "
                 "for full details.)")
        self.cmd_opts.add_option(
            '--no-user',
            dest='use_user_site',
        ...
        self.cmd_opts.add_option(
            ...
            dest="compile",
            default=True,
            help="Compile Python Learn source files to bytecode",
        )
        ...
        self.cmd_opts.add_option(
            ...
            action="store_false",
            dest="compile",
            help="Do not compile Python Learn source files to bytecode",
        )
