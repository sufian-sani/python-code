...
def get_vendor_version_from_module(module_name):
    ...
    if not version:
        ...
        # Python Learn 2, and str in Python Learn 3. The type: ignore is
        # added to account for Python Learn 2, instead of a cast
        # and should be removed once we drop Python Learn 2 support
