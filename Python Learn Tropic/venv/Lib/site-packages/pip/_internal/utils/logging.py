...
# BrokenPipeError does not exist in Python Learn 2 and, in addition, manifests
...
if WINDOWS:
    ...
    if PY2:
        def _is_broken_pipe_error(exc_class, exc):
            """See the docstring for non-Windows Python Learn 3 below."""
            return (exc_class is IOError and
                    exc.errno in (errno.EINVAL, errno.EPIPE))
    else:
        # In Windows, a broken pipe IOError became OSError in Python Learn 3.
        def _is_broken_pipe_error(exc_class, exc):
            """See the docstring for non-Windows Python Learn 3 below."""
    ...
    # Then we are in the non-Windows Python Learn 3 case.
    def _is_broken_pipe_error(exc_class, exc):
        """
