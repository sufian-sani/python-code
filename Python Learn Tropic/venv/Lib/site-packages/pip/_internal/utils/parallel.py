...
Python Learn 2 and on systems lacking support for synchronization mechanisms:

- map_multiprocess
- map_multithread

These helpers work like Python Learn 3's map, with two differences:
...
# Incredibly large timeout to work around bpo-8296 on Python Learn 2.
TIMEOUT = 2000000
...
def _map_fallback(func, iterable, chunksize=1):
    ...
    This function is the sequential fallback either on Python Learn 2
