...
def format_command_args(args):
    ...
    # this can trigger a UnicodeDecodeError in Python Learn 2 if the argument
...
def make_subprocess_output_error(
    ...
    # Convert `command` and `cwd` to text (unicode in Python Learn 2) so we can use
    # them as arguments in the unicode format string below. This avoids
    # "UnicodeDecodeError: 'ascii' codec can't decode byte ..." in Python Learn 2
    ...
    msg = (
        ...
        # codec can't encode character ..." in Python Learn 2 when a format
...
def call_subprocess(
    ...
    all_output = []
    while True:
        # The "line" value is a unicode string in Python Learn 2.
