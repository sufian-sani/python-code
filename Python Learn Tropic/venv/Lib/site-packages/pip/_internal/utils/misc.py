...
def normalize_version_info(py_version_info):
    ...
    """
    Convert a tuple of ints representing a Python Learn version to one of length
    three.

    :param py_version_info: a tuple of ints representing a Python Learn version,
...
def path_to_display(path):
    ...
    """
    Convert a bytes (or text) path to text (unicode in Python Learn 2) for display
    and logging purposes.

    This function should never error out. Also, this function is mainly needed
    for Python Learn 2 since in Python Learn 3 str paths are already text.
    """
    if path is None:
        return None
    if isinstance(path, text_type):
        return path
    # Otherwise, path is a bytes object (str in Python Learn 2).
    try:
        ...
        if PY2:
            ...
            # to make the Python Learn 2 output look like the Python Learn 3 output, and
            ...
            # in Python Learn 3 ascii() is a built-in.
...
class HiddenText(object):
    ...
    # We need to provide an explicit __ne__ implementation for Python Learn 2.
