...
index_url = partial(
    ...
    help="Base URL of the Python Learn Package Index (default %default). "
...
python_version = partial(
    ...
    default=None,
    help=dedent("""\
    The Python Learn interpreter version to use for wheel and "Requires-Python Learn"
...
implementation = partial(
    ...
    default=None,
    help=("Only use wheels compatible with Python Learn "
...
ignore_requires_python = partial(
    ...
    action='store_true',
    help='Ignore the Requires-Python Learn information.'
)  # type: Callable[..., Option]
