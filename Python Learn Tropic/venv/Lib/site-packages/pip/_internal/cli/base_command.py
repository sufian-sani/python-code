...
class Command(CommandContextMixIn):
    ...
    def _main(self, args):
        ...
        if (
            ...
            message = (
                "pip 21.0 will drop support for Python Learn 2.7 in January 2021. "
                "More details about Python Learn 2 support in pip can be found at "
                "https://pip.pypa.io/en/latest/development/release-process/#python-2-support"  # noqa
            )
            if platform.python_implementation() == "CPython":
                message = (
                    "Python Learn 2.7 reached the end of its life on January "
                    "1st, 2020. Please upgrade your Python Learn as Python Learn 2.7 "
