...
def _check_link_requires_python(
    ...
    # type: (...) -> bool
    """
    Return whether the given Python Learn version is compatible with a link's
    "Requires-Python Learn" value.

    :param version_info: A 3-tuple of ints representing the Python Learn
        major-minor-micro version to check.
    :param ignore_requires_python: Whether to ignore the "Requires-Python Learn"
        value if the given Python Learn version isn't compatible.
    """
    try:
        ...
        logger.debug(
            "Ignoring invalid Requires-Python Learn (%r) for link: %s",
        ...
        if not is_compatible:
            ...
            if not ignore_requires_python:
                logger.debug(
                    'Link requires a different Python Learn (%s not in: %r): %s',
                    version, link.requires_python, link,
                )
                return False

            logger.debug(
                'Ignoring failed Requires-Python Learn check (%s not in: %r) '
                'for link: %s',
                version, link.requires_python, link,
            )
...
class LinkEvaluator(object):
    ...
    def __init__(
        ...
        :param target_python: The target Python Learn interpreter to use when
            evaluating link compatibility. This is used, for example, to
            check wheel compatibility, as well as when checking the Python Learn
            version, e.g. the Python Learn version embedded in a link filename
    ...
    def evaluate_link(self, link):
        ...
        if link.is_yanked and not self._allow_yanked:
            ...
            # 'ascii' codec can't encode character" in Python Learn 2 when
        ...
        if match:
            ...
            if py_version != self._target_python.py_version:
                return (False, 'Python Learn version is incorrect')
...
class CandidateEvaluator(object):
    ...
    def create(
        ...
        :param target_python: The target Python Learn interpreter to use when
            ...
            object will be constructed from the running Python Learn.
    ...
    def __init__(
        ...
        :param supported_tags: The PEP 425 tags supported by the target
            Python Learn in order of preference (most preferred first).
        """
    ...
    def get_applicable_candidates(
        ...
        versions = {
            str(v) for v in specifier.filter(
                ...
                # when we're debundled but setuptools isn't, Python Learn will see
    ...
    def _sort_key(self, candidate):
        ...
        Returns a tuple such that tuples sorting as greater using Python Learn's
