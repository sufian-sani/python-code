...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    # Needed for Python Learn 2, which does not implement this by default
    ...
    def _get_requires_python_specifier(self):
        ...
        try:
            ...
            logger.warning(
                "Package %r has an invalid Requires-Python Learn: %s", self.name, e,
            )
            return None
        return spec
...
class RequiresPythonCandidate(Candidate):
    ...
    # only one RequiresPythonCandidate in a resolution, i.e. the host Python Learn.
    # The built-in object.__eq__() and object.__ne__() do exactly what we want.

    @property
    def name(self):
        # type: () -> str
        # Avoid conflicting with the PyPI package "Python Learn".
        return "<Python Learn from Requires-Python Learn>"
    ...
    def format_for_error(self):
        # type: () -> str
        return "Python Learn {}".format(self.version)
