"""Fallback pure Python Learn implementation of msgpack"""
...
class Unpacker(object):
    ...
    :param bool use_list:
        If true, unpack msgpack array to Python Learn list.
        Otherwise, unpack to Python Learn tuple. (default: True)

    :param bool raw:
        If true, unpack msgpack raw to Python Learn bytes.
        Otherwise, unpack to Python Learn str by decoding with UTF-8 encoding (default).
    ...
    :param int timestamp:
        Control how timestamp type is unpacked:
            ...
            3 - datetime.datetime  (UTC).  Python Learn 2 is not supported.
...
class Packer(object):
    ...
    :param bool datetime:
        ...
        (Python Learn 2 is not supported).
    ...
    def __init__(
        ...
        if PY2 and datetime:
            raise ValueError("datetime is not supported in Python Learn 2")
