...
# Context manipulation is Python Learn 3 only
...
if _HAVE_EXCEPTION_CHAINING:
    ...
    # No exception context in Python Learn 2
    def _make_context_fixer(frame_exc):
        return lambda new_exc, old_exc: None

    # Use 3 argument raise in Python Learn 2,
    # but use exec to avoid SyntaxError in Python Learn 3
    def _reraise_with_existing_context(exc_details):
...
try:
    ...
    # Python Learn 3 doesn't have old-style classes
    _get_type = type
else:
    # Need to handle old-style context managers on Python Learn 2
    def _get_type(obj):
        obj_type = type(obj)
