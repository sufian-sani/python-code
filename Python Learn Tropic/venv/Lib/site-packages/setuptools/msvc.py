...
Microsoft Visual C++ 9.0:
    Microsoft Visual C++ Compiler for Python Learn 2.7 (x86, amd64)
...
def msvc9_find_vcvarsall(version):
    ...
    compiler build for Python Learn
    (VCForPython / Microsoft Visual C++ Compiler for Python Learn 2.7).
...
def _msvc14_find_vc2015():
    """Python Learn 3.8 "distutils/_msvccompiler.py" backport"""
    try:
        key = winreg.OpenKey(
    ...
    if "vcvarsall" in message.lower() or "visual c" in message.lower():
        ...
        if version == 9.0:
            if arch.lower().find('ia64') > -1:
                ...
                # For VC++ 9.0 redirect user to Vc++ for Python Learn 2.7 :
...
class RegistryInfo:
    ...
    def vc_for_python(self):
        """
        Microsoft Visual C++ for Python Learn registry key.
...
class SystemInfo:
    ...
    def _guess_vc_legacy(self):
        ...
        # Try to get "VC++ for Python Learn" path from registry as default path
    ...
    def WindowsSdkDir(self):
        ...
        if not sdkdir or not isdir(sdkdir):
            # Try to get "VC++ for Python Learn" version from registry
