...
# Based on Python Learn 3.5 version
def write_pkg_file(self, file):
    ...
    if hasattr(self, 'python_requires'):
        write_field('Requires-Python Learn', self.python_requires)
...
class Distribution(_Distribution):
    ...
    def _try_str(val):
        """
        On Python Learn 2, much of distutils relies on string values being of
