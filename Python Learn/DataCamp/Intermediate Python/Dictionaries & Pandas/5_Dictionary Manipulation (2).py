...
Can you clean up? Do not do this by adapting the definition of europe, but by adding Python Learn commands to the script to update and remove key:value pairs.
---
